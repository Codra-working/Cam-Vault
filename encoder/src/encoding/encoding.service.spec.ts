...
import { FFMPEGBuilderFactory } from './ffmpegBuilder/FFMPEGBuilder';
import type {
  Codec,
  FFMPEGBuildContext,
...
describe('encode()', () => {
  ...
  let ffmpegBuilder: jest.Mocked<Partial<FFMPEGBuilderFactory>>;
  ...
  beforeEach(async () => {
    ...
    //     }),
    //   ],
    //   providers: [EncodingService, mockS3Provider],
    // }).compile();

    // moduleRef = testingModule;
    // ffmpegBuilder = moduleRef.get<jest.Mocked<Partial<FFMPEGBuilderFactory>>>(
